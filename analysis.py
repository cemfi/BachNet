...
from model import AnalysisNet, PlotNeuronNet
...
model = AnalysisNet(input_dims=279, hidden_dims=hiddenSize, output_dims=279, num_hidden_layers=numberHidden, dropout=dropout, neurons=plot_pairs).to(device)  # former hidden 600 - wasnt better?
