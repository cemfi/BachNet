...
if __name__ == '__main__':
    ...
    checkpoint_path = f'{thispath}/checkpoints/2019-06-14_21-09-06 batch_size=8192 hidden_size=650 context_radius=32 time_grid=0.25 lr=0.0005 lr_gamma=0.98 lr_step_size=10 split=0.05 0870.pt'
    
    # checkpoint_path = f'{thispath}/checkpoints/2019-06-13_23-54-23 batch_size=8192 hidden_size=650 context_radius=32 time_grid=0.25 lr=0.0005 lr_gamma=0.98 lr_step_size=10 split=0.05 1000.pt'

    soprano_path = f'{thispath}/XML/melody.XML'
    ...
    score.write('musicxml', f'{thispath}/XML/harmony.xml')
    #score.show('musicxml')
