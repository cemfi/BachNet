...
if __name__ == '__main__':
    ...
    checkpoint_path = './checkpoints/2019-06-14_21-09-06 batch_size=8192 hidden_size=650 context_radius=32 time_grid=0.25 lr=0.0005 lr_gamma=0.98 lr_step_size=10 split=0.05 0870.pt'

    soprano_path = f"/Users/alexanderleemhuis/Cemfi/2019_06 Bacher/Präsentation/fun examples/kirby fsharp fermata 2.mxl"
    #soprano_path = f'/Users/alexanderleemhuis/Informatik/PY/PRJ/bach git/BACKUP 27.5./xml test/kirby only last fermata.musicxml'
